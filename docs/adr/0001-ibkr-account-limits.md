...
| 4 | Market data lines | **Provozní strop 100** (revize 27. 8. 2026). Původní „≥ 150" měřilo jen nepřítomnost error 101, ne doručení dat — provoz ukázal, že linky nad ~100 tiše mlčí. Přeměření s ověřením doručení (sonda #631, 27. 8., engine zastaven, ES 20260918, dávky à 10): **80/80 subskribovaných kontraktů reálně dodává, 0 chyb**; víc kontraktů se v pásmu nekvalifikovalo, takže samotný práh 100 sondou překročen nebyl — hodnota 100 zůstává z provozního pozorování (souběh s mobilem/TWS okny, chybně mlčící linky nad limitem). `GEXLENS_BATCH_SIZE` nezvyšovat. |
