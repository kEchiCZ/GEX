...
*Verze 1.2 · červenec 2026 · pro aplikaci GEXLens v0.1*
...
- **Multi-instrument** — watchlist v sidebaru: přidej ticker (ES, NQ, RTY…) a engine ho začne sbírat; kliknutím přepínáš celou aplikaci.
...
| **Řádek přepínačů** | Checkboxy vrstev: **Dyn GEX** (walls linie), **GEX Levels** (flip/centroid/Max Pain), **Sessions** (automatické markery světových seancí), **Vol / Opt Vol / Delta / Δ Flow C/P** (spodní panely), **Vol + OI Δ**, **News**. Co odškrtneš, zmizí — layout se přeskládá. |
...
Graf se při načtení **automaticky napasuje na cenové pásmo dne** (svíčky vyplní výšku); okolní zóny heatmapy dosáhneš tažením/kolečkem za osu Y, reset vrací napasovaný pohled.
...
- **Šířku panelu změníš tažením předělu** mezi grafem a panelem (kurzor ↔, rozsah 180–640 px)
