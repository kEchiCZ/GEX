...
| `GEXLENS_NEWS_EXPLAIN_MODEL` | gemini-3.8-flash | Model — **pinovat konkrétní verzi**, ne alias `*-latest` (#738); `thinkingLevel: low` (3.8-flash `minimal` odmítá 400). Jedno vysvětlení ≈ 600 tokenů; 5xx „high demand" se zkusí jednou znovu po 2 s |
