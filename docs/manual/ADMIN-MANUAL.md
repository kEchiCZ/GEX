...
| `derived/{sym}/flow/{date}.parquet` | ts_min, flow_delta, cum_delta, futures_cvd*, **source** (v1.4, ADR-0032: `midpoint` / `dxfeed`; NULL = partice před #615 fází 3 = midpoint) |
